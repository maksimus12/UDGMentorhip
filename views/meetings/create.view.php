...
<!--                                >-->
<!--                                --><?php //foreach($students as $student):?>
<!--                                    <option value="--><?php //= htmlspecialchars($student['id'])?><!--">--><?php //= htmlspecialchars($student['fname'])?><!--</option>-->
<!--                                --><?php //endforeach?>
<!--                                </select>-->
<!---->
<!--                                --><?php //if (isset($errors['body'])) : ?>
<!--                                    <p class="text-red-500 text-xs mt-2">--><?php //= $errors['body'] ?><!--</p>-->
<!--                                --><?php //endif; ?>
<!--                        </div>-->
<!--                        </div>       -->
<!--                        <div>-->
...
<!--                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"-->
<!--                                    placeholder="Metting Topic"-->
<!--                                >--><?php //= $_POST['topic'] ?? '' ?><!--</input>-->
<!---->
<!--                                --><?php //if (isset($errors['topic'])) : ?>
<!--                                    <p class="text-red-500 text-xs mt-2">--><?php //= $errors['topic'] ?><!--</p>-->
<!--                                --><?php //endif; ?>
<!--                        </div>-->
<!--                        </div>-->
<!--                            <div>-->
